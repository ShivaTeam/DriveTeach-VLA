...
class ModelArguments(
    ...
    # DVD (Driving-aware Vision Distillation) parameters
    enable_dvd: bool = field(default=False, metadata={"help": "Enable DVD distillation."})
    dvd_h_size: int = field(default=16, metadata={"help": "DVD regional loss block count along height."})
    dvd_w_size: int = field(default=28, metadata={"help": "DVD regional loss block count along width."})
    dvd_tgp_weight: float = field(default=0.1, metadata={"help": "Weight for TGP loss in total loss."})
    dvd_ema: float = field(default=0.996, metadata={"help": "EMA decay for teacher ViT in DVD."})
